...
with the balls defined w.r.t. the Hamming metric. If we were to go down the
vanilla Gilbert-Varshamov route, we would now upper bound the r.h.s. by
...
\begin{align}
  ...
  \, ,
\end{align}
for any $$i \neq j$$. Hence $$2 |M|$$ lower bounds the desired
