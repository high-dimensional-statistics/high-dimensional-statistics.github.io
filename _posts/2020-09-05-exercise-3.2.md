...
$$\sigma$$-algebra on $$ \mathcal{X}_1 \times \mathcal{X}_2 $$
...
\begin{align}
  ...
  \int \\! \\! \int
    ...
    \tfrac{\sd \mathbb{Q}\_1}{\sd \mathbb{Q}\_1} (x\_1)
...
Using the rectangles $$ A_1 \times \mathcal{X}_2 $$,
$$ A_1 \subseteq \mathcal{X}_1 $$ measurable, it is clear
...
# TODO: handle the case when things are infinite
